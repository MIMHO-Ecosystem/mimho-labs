# MIMHO EventsHub V2 — Mythril Results
...
myth analyze src/eventshub.sol --solv 0.8.28 --execution-timeout 300 --max-depth 22 --solc-json mythril-solc-settings.json
...
Mythril did not detect symbolic execution issues in the tested EventsHub V2 target.
